...
// WithLogger sets the logger. Otherwise it defaults to olog.New
...
// WithHTTPAppHandler sets the http handler for the app. Otherwise it defaults to NotFound
func WithHTTPAppHandler(appHandler http.Handler) Option {
	return optionFunc(func(o *runOpts) error {
