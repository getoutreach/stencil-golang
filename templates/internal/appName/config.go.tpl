...
// MarshalLog is used to write config to log.
func (c *Config) MarshalLog(addfield func(key string, value any)) {
...
// nolint:nolintlint,funlen // Why: This function is long for extensibility reasons since it is generated by stencil.
